    ...
    def compute_loss_pi(data):
       ...
       # print('llm score', llm_score, 'llm conf ==', llm_score_conf)
        if not torch.all(llm_score == 0) and not torch.all(llm_score_conf == 0):
            entropy_coef = 0.01 * (5 - llm_score) * llm_score_conf  # Higher score → less entropy
...
# Save the model
model_path = TRAINED_MODEL_DIR + "drive/MyDrive/FinRL_DeepSeek/trained_models/agent_cppo_llm10_ent1_20_epochs_20k_steps_trail_gpu.pth"
