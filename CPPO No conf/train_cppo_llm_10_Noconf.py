...
from env_trading_cppo_Noconf import StockTradingEnv
...
train = train.drop('Confidence_Sen',axis=1)
train = train.drop('Confidence_Risk',axis=1)
...
#            llm_risks_weights = llm_risks_weights.flatten() 
    #        +    # New dictionary with wider range
            ...
            R_f_mod = 1.0 + (base_risk_factors - 1.0) * BETA #confidence_risk * BETA
...
# Save the model
model_path = TRAINED_MODEL_DIR + "/agent_cppo_llm10_Noconf_100_epochs_20k_steps.pth"
