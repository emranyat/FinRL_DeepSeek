...
# Pass 'env_train' as a string, which can be later used to access the actual object
parser.add_argument('--env', type=object, default='env_train') 
...
train = pd.read_csv('train_data_deepseek_risk_2013_2018_trial.csv')
# Convert to pandas DataFrame
#train = pd.DataFrame(dataset['train'])
train = train.drop('Unnamed: 0',axis=1)
train = train.drop(['llm_risk', 'Confidence_Risk', 'Confidence_Sen', 'llm_sentiment'],axis=1)
print(train.columns)
...
# Access the 'env_train' object using globals()
...
# Save the model
model_path = TRAINED_MODEL_DIR + "/agent_ppo_20_epochs_20k_steps.pth"
