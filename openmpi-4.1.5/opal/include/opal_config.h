...
#define MCA_io_romio321_COMPLETE_CONFIGURE_FLAGS " FROM_OMPI=yes CC='gcc' CFLAGS='-O3 -DNDEBUG -finline-functions -fno-strict-aliasing -mcx16  -D__EXTENSIONS__' CPPFLAGS='    -I/usr/local/include -I/usr/local/include' FFLAGS='' LDFLAGS='   ' --enable-shared --disable-static  --prefix=/homes/eya24/.local --disable-aio --disable-weak-symbols --enable-strict --disable-f77 --disable-f90"
...
#define OPAL_PACKAGE_STRING "Open MPI eya24@potoo01.doc.ic.ac.uk Distribution"
