...
from env_trading_cppo_llm01 import StockTradingEnv
...
#            llm_risks_weights = llm_risks_weights.flatten() 
    #        +    # New dictionary with wider range
            risk_to_weight = {1: 0.9990, 2: 0.9995, 3: 1.00, 4: 1.0005, 5: 1.0010}
...
# Save the model
model_path = TRAINED_MODEL_DIR + "/agent_cppo_llm01_20_epochs_20k_steps.pth"
